        ...
        <div class="relative">
            ...
            <div class="absolute full_select_box" :class="{hidden:selecting_option}">
                <div class="flex flex-col">
                    ...
                    <input type="file" id="file_selector" class="hidden" @change="select_file">
...
export default {
    ...
    methods: {
        ...
        select_file(file_details) {
            console.log("this is selected img", file_details.target.files[0].name);
            ...
            reader.addEventListener('load',()=>{
                this.selected_file.msg=reader.result;
            })
